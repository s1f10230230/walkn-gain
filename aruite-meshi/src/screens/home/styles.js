...
const styles = StyleSheet.create({
  ...
  feedbackRefreshButton: { paddingHorizontal: 8, paddingVertical: 4 },
  feedbackRefreshText: { fontSize: 13, fontWeight: '600' },
  aiBadge: {
    flexDirection: 'row',
    alignItems: 'center',
    borderWidth: 1,
  ...
  restBadgeText: { fontSize: 12, fontWeight: '700' },
  feedbackLine: { fontSize: 14, lineHeight: 20, marginBottom: 4 },
  feedbackApplyButton: {
    marginTop: 10,
    alignSelf: 'flex-start',
    paddingHorizontal: 12,
  ...
  feedbackApplyText: { color: '#FFF', fontWeight: '700', fontSize: 13 },
  dateNavigation: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "center",
